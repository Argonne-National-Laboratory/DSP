...
DSP_RTN_CODE DecDdMasterDSB::createProblem(DecModel * model)
{
#define FREE_MEMORY            \
...
DSP_RTN_CODE DecDdMasterDSB::updateProblem(
...
/** apply level change */
DSP_RTN_CODE DecDdMasterDSB::applyLevelChange()
{
#define FREE_MEMORY \
	FREE_ARRAY_PTR(obj);
...
DSP_RTN_CODE DecDdMasterDSB::updateDynObjs()
{
	BGN_TRY_CATCH
...
/** solve problem */
DSP_RTN_CODE DecDdMasterDSB::solve()
{
	BGN_TRY_CATCH
...
/** manage bundle */
DSP_RTN_CODE DecDdMasterDSB::manageBundle(

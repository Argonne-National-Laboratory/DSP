...
/** create problem */
DSP_RTN_CODE DecDdPrimalMaster::createProblem(DecModel * model)
{
#define FREE_MEMORY       \
...
DSP_RTN_CODE DecDdPrimalMaster::updateProblem(
...
/** solve problem */
DSP_RTN_CODE DecDdPrimalMaster::solve()
{
...
/** aging cuts */
DSP_RTN_CODE DecDdPrimalMaster::agingCuts()
{
	/** exit if no cut */
...
/** possibly delete cuts */
DSP_RTN_CODE DecDdPrimalMaster::possiblyDeleteCuts(
...
/** remove all cuts from solver interface */
DSP_RTN_CODE DecDdPrimalMaster::removeAllCuts()
{
	SolverInterfaceClp * clp = dynamic_cast<SolverInterfaceClp*>(si_);
	SolverInterfaceOoqp * ooqp = dynamic_cast<SolverInterfaceOoqp*>(si_);
	if (clp)

...
parser = argparse.ArgumentParser(description='This is a PyDsp example for deterministic equivalent solution.')
...
# solve the deterministic equivalent form
PyDsp.solveDe(dsp)

# solution status
status = PyDsp.getSolutionStatus(dsp)

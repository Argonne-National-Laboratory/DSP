...
C  17/9/09. Bug corrected in MA27H.  Also some tidying of code in
C     MA27H and change of most comments to lower case.
C  16/6/10. Statement function in MA27O replaced by in-line code.
...
C COMPRESS IW TO REMOVE DUMMY ENTRIES CAUSED BY DUPLICATES.
  ...
  310 RETURN
     ...
     +                 NCMPA,FRATIO)
C Bug was found in the then identical subroutine MA57H which was then
C     corrected.
